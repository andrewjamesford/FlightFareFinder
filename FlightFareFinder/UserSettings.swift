...
func loadUserSettings() -> (origin: String?, destination: String?, alertAmount: NSInteger, dateFrom: NSDate?, notificationsEnabled: Bool)
{
...
func setUserSettings(origin: String?, destination: String?, alertAmount: NSInteger?, dateFrom: NSDate?, notificationsEnabled: Bool?) {
